...
import { searchSoftware, subscriptionTools, software } from '@/lib/data';
  ...
  return (
    <div>
      {query ? (
        ...
        <div>
          <div className="mb-10">
            <h1 className="heading-editorial text-3xl text-slate-900 mb-2">Browse alternatives</h1>
            <p className="text-slate-500">Find software you can actually own.</p>
          </div>
